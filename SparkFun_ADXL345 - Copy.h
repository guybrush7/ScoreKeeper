...
public:
	...
	void EnableTriggerMode(uint8_t int_pin, uint8_t preTrigSamples);
	void DisableTriggerMode(void);
	bool isFifoTriggered(uint8_t &fifoEntries);
